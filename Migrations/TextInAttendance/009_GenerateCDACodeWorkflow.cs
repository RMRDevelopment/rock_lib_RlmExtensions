...
namespace com.reallifeministries.RockExtensions.Migrations
{
    ...
    class _009_GenerateCDACodeWorkflow : Migration
    {
        ...
        public override void Up()
        {
            ...
            RockMigrationHelper.UpdateWorkflowType(false, true, "Generate CDA Code", "", "4D57D6C1-B4A1-4CC1-BD79-71EF8494ED70", "Work", "fa fa-list-ol", 0, true, 0, "7B06A50F-1F78-4D7A-8232-E9044A327E77"); // Generate CDA Code
            ...
            RockMigrationHelper.AddAttributeQualifier("93EF2488-7F6F-487A-9D40-FD0906522F5E", "ispassword", @"False", "028A59FE-6836-4A56-AED7-0EEA3EF2E675"); // Generate CDA Code:GeneratedCode:ispassword
